...
{
    $OutputText = [OpenccFmmsegLib.OpenccFmmseg]::new().Convert($InputText, "s2tw", $Punctuation)
    $InputEncode = "Simplified Chinese 简体"
    $OutputEncode = "Traditional Chinese 繁体/台湾"
}
elseif ($Config -eq "tw2s")
{
    $OutputText = [OpenccFmmsegLib.OpenccFmmseg]::new().Convert($InputText, "tw2s", $Punctuation)
    $InputEncode = "Traditional Chinese 繁体/台湾"
    $OutputEncode = "Simplified Chinese 简体"
}
elseif ($Config -eq "s2hk")
{
    $OutputText = [OpenccFmmsegLib.OpenccFmmseg]::new().Convert($InputText, "s2hk", $Punctuation)
    $InputEncode = "Simplified Chinese 简体"
    $OutputEncode = "Traditional Chinese 繁体/香港"
}
elseif ($Config -eq "hk2s")
{
    $OutputText = [OpenccFmmsegLib.OpenccFmmseg]::new().Convert($InputText, "hk2s", $Punctuation)
    $InputEncode = "Traditional Chinese 繁体/香港"
    $OutputEncode = "Simplified Chinese 简体"
}
elseif ($Config -eq "s2twp")
{
    $OutputText = [OpenccFmmsegLib.OpenccFmmseg]::new().Convert($InputText, "s2twp", $Punctuation)
    $InputEncode = "Simplified Chinese 简体"
    $OutputEncode = "Traditional Chinese 繁体/台湾"
}
elseif ($Config -eq "tw2sp")
{
    $OutputText = [OpenccFmmsegLib.OpenccFmmseg]::new().Convert($InputText, "tw2sp", $Punctuation)
    $InputEncode = "Traditional Chinese 繁体/台湾"
    $OutputEncode = "Simplified Chinese 简体"
}
elseif ($Config -eq "t2tw")
{
    $OutputText = [OpenccFmmsegLib.OpenccFmmseg]::new().Convert($InputText, "t2tw", $Punctuation)
    $InputEncode = "Simplified Chinese 繁体"
    $OutputEncode = "Traditional Chinese 繁体/台湾"
}
elseif ($Config -eq "tw2t")
{
    $OutputText = [OpenccFmmsegLib.OpenccFmmseg]::new().Convert($InputText, "tw2t", $Punctuation)
    $InputEncode = "Traditional Chinese 繁体/台湾"
    $OutputEncode = "Simplified Chinese 繁体"
}
elseif ($Config -eq "t2twp")
{
    $OutputText = [OpenccFmmsegLib.OpenccFmmseg]::new().Convert($InputText, "t2twp", $Punctuation)
    $InputEncode = "Simplified Chinese 繁体"
    $OutputEncode = "Traditional Chinese 繁体/台湾"
}
elseif ($Config -eq "tw2tp")
{
    $OutputText = [OpenccFmmsegLib.OpenccFmmseg]::new().Convert($InputText, "tw2tp", $Punctuation)
    $InputEncode = "Traditional Chinese 繁体/台湾"
    $OutputEncode = "Simplified Chinese 简体"
}
elseif ($Config -eq "t2hk")
{
    $OutputText = [OpenccFmmsegLib.OpenccFmmseg]::new().Convert($InputText, "t2hk", $Punctuation)
    $InputEncode = "Simplified Chinese 繁体"
    $OutputEncode = "Traditional Chinese 繁体/香港"
}
elseif ($Config -eq "hk2t")
{
    $OutputText = [OpenccFmmsegLib.OpenccFmmseg]::new().Convert($InputText, "hk2t", $Punctuation)
    $InputEncode = "Traditional Chinese 繁体/香港"
    $OutputEncode = "Simplified Chinese 繁体"
}
elseif ($Config -eq "t2jp")
{
    $OutputText = [OpenccFmmsegLib.OpenccFmmseg]::new().Convert($InputText, "t2jp", $Punctuation)
    $InputEncode = "Japanese Kyujitai 舊字體"
    $OutputEncode = "Japanese Shinjitai 新字体"
}
elseif ($Config -eq "jp2t")
{
    $OutputText = [OpenccFmmsegLib.OpenccFmmseg]::new().Convert($InputText, "jp2t", $Punctuation)
